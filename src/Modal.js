    ...
    <div className="sm:relative">
      ...
      {showModal ? (
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl text-gray-600 dark:text-gray-100 ">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white dark:bg-gray-800  outline-none focus:outline-none">
                ...
                {/*body*/}
                <div className="relative px-6 py-3 flex-auto my-4 leading-relaxed">
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b text-white">
                  <button
                    className="rounded px-3 py-2 m-1 bg-blue-700 border-b-4 border-l-2 shadow-lg border-blue-800 dark:bg-gray-700 dark:border-gray-800 uppercase"
                    type="button"
